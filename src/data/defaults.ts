...
export const DEFAULT_CATEGORIES: PortfolioCategory[] = [
  ...
  { name: 'Weddings', slug: 'weddings', order: 1 },
  { name: 'Couples', slug: 'couples', order: 2 },
  { name: 'Portraits', slug: 'portraits', order: 3 },
  { name: 'Fashion', slug: 'fashion', order: 4 },
  { name: 'Events', slug: 'events', order: 5 },
];
