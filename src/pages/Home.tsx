    ...
    <div id="home-page-container" className="bg-[#F4F1EC] text-[#1C1C1A] selection:bg-[#6B4F3A] selection:text-[#F4F1EC]">
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative mx-auto max-w-lg lg:max-w-none">
                ...
                <div className="relative rounded-[6px] overflow-hidden shadow-2xl film-grain bg-[#E8E3DB]">
                  <img
                    src={getMediaUrl('home_hero', 'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1400&q=85')}
                    alt={getMediaAlt('home_hero', '1 by 2 Studio Chennai Editorial Portraiture')}
      ...
      <section id="featured-story-section" className="relative min-h-[75vh] flex items-center justify-center overflow-hidden border-b border-[#D8D2C8]">
        ...
        <div className="absolute inset-0">
          <img
            src={getMediaUrl('home_featured_story', 'https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?auto=format&fit=crop&w=2000&q=85')}
            alt={getMediaAlt('home_featured_story', 'An evening by the coast - Chennai Pre-Wedding Story')}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative rounded-[6px] overflow-hidden border border-[#D8D2C8] shadow-lg film-grain bg-[#E8E3DB]">
                <img
                  src={getMediaUrl('home_about', 'https://images.unsplash.com/photo-1542038784456-1ea8e935640e?auto=format&fit=crop&w=1200&q=85')}
                  alt={getMediaAlt('home_about', '1 by 2 Studio Founders & Equipment')}
