        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-6 relative">
            <div className="relative rounded-[6px] overflow-hidden border border-[#D8D2C8] shadow-lg film-grain bg-[#E8E3DB]">
              <img
                src={getMediaUrl('about_story', content.about.image || 'https://images.unsplash.com/photo-1542038784456-1ea8e935640e?auto=format&fit=crop&w=1200&q=85')}
                alt={getMediaAlt('about_story', siteSettings.studioName)}
